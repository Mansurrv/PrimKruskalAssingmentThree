...
public class PrimAlgorithmBaselineTest {
    private PrimResult createSmallGraphResult() {
        Node n1 = new Node(); n1.id = 0;
        Node n2 = new Node(); n2.id = 1;
        Node n3 = new Node(); n3.id = 2;
        Node n4 = new Node(); n4.id = 3;

        Edge e1 = new Edge(); e1.source = 0; e1.target = 1; e1.weight = 1;
        Edge e2 = new Edge(); e2.source = 1; e2.target = 2; e2.weight = 2;
        Edge e3 = new Edge(); e3.source = 2; e3.target = 3; e3.weight = 3;
        Edge e4 = new Edge(); e4.source = 3; e4.target = 0; e4.weight = 4;
    ...
    void testDisconnectedGraph() {
        ...
        PrimAlgorithmBaseline algorithm = new PrimAlgorithmBaseline();
        PrimResult result = algorithm.primOptimized(nodes, edges);
